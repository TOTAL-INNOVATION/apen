                    ...
                    <table>
                        <tr>
                            <td>
                                ...
                                <p class="text-center" style="margin-top: 1.5rem; color: #8d8d8d;">{{ __('Si vous n\'êtes pas l\'auteur de cette inscription sur la plateforme, veuillez l\'ignorer. Le compte utilisant votre adresse email sera supprimer au bout de 3 jours.') }}</p>
                            </td>
                        </tr>
                    </table>
                </div>
