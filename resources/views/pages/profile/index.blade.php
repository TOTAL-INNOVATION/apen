		...
		<div class="px-4 sm:px-0 container">
            <div class="max-w-2xl mx-auto">
                ...
                <x-form action="{{ route('profile.updateAvatar') }}" method="POST" enctype="multipart/form-data">
                    <x-form.label for="avatar" class="mx-auto relative w-36 h-36 border-[4px] border-rainee rounded-full" title="Cliquez pour charger une image">
                        <img src="{{ $user->avatar }}" alt="{{ $user->fullname }}" class="w-full h-full rounded-full" id="preview">
                    ...
                    <x-input id="avatar" name="avatar" type="file" class="hidden" accept="image/png, image/jpg, image/jpeg" required />
                    ...
                    <x-card.body>
                        <x-form action="{{ route('profile.updatePassword') }}" method="POST">
                            ...
                            <x-form.field
                                ...
                                placeholder="{{ __('Entrez à nouveau votre mot de passe') }}"
                                required
                            />
