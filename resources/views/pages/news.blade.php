<x-app-layout>
	...
	<main class="py-4">
		...
		<div class="px-4 mt-4 sm:px-0 sm:mt-6 md:mt-8 lg:mt-12 container">
			...
			<div class="mt-2 sm:mt-4 md:mt-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
				@for ($i = 0; $i < 6; $i++)
					<x-news-card
			...
			<div class="py-6">
				<div class="flex gap-x-2 sm:gap-x-4">
					...
					<span class="h-10 w-10 inline-flex items-center justify-center text-sm sm:text-base font-franklin-medium border border-whisper">1</span>
