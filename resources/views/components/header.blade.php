            ...
            <div class="flex-initial">
                <div class="flex items-center space-x-4">
                    ...
                    <div class="md:hidden">
                        ...
                        <div id="apen-offcanvas-menu" class="hs-overlay hs-overlay-open:translate-x-0 hs-overlay-backdrop-open:bg-dark/30 hidden -translate-x-full fixed top-[70.75px] sm:top-[84px] md:top-0 start-0 transition-all duration-300 transform h-full max-w-xs w-full z-[80] bg-white border-e border-whisper overflow-y-scrollr" role="dialog" tabindex="-1">
